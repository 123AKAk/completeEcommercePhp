				...
				<div class="product">
					<div class="row">
						...
						<div class="col-md-7">
                            ...
                            <form id="addToCartIframe"  method="post">
                            <div class="p-quantity">
                                <div class="row">
                                    <?php if(isset($size)): ?>
                                    <div class="col-md-12 mb_20">
                                        <?php echo LANG_VALUE_52; ?> <br>
                                        <select name="size_id" class="form-control select2" style="width:auto;" id="size_id">
                                            <?php
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select name="color_id" id="color_id" class="form-control select2" style="width:auto;">
                                            <?php
                            ...
                            <input type="hidden" name="p_name" id="p_name" value="<?php echo $p_name; ?>">
                            <input type="hidden" name="p_featured_photo" id="p_featured_photo" value="<?php echo $p_featured_photo; ?>">
                            <input type="hidden" name="eypid" id="eypid" value="<?php echo implode(" ",array($_REQUEST['id'])); ?>">
							<div class="p-quantity">
                                <?php echo LANG_VALUE_55; ?> <br>
								<input type="number" class="input-text qty" step="1" min="1" max="" id="p_qty" name="p_qty" value="1" title="Qty" size="4" pattern="[0-9]*" inputmode="numeric">
							</div>
							<div class="btn-cart btn-cart1" id="cartBtnRefresh">
                                <?php
                                    if(isset($_SESSION['cart_p_id']))
                                    {
                                        ...
                                        {
                                            $epid = implode(" ",array($_REQUEST['id']));

                                            if( ($arr_cart_p_id[$i]== $epid))
                                            {
                                                $added = 1;
                                                break;
                                            }
                                        ...
                                        if($added == 1) 
                                        {
                                            echo '<input style="background:dodgerblue;" type="submit" value="Added" name="form_add_to_cart">';
                                        }
                                        else
                                        {
                                            ?>
