...
<div class="page" id="checkoutpgtbl">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <th class="total-amount" id="realtotal">
                                <?php
                ...
                <div class="billing-address">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p id="ecemail" style="display:none"><?php echo $_SESSION['customer']['cust_email']; ?></p>
                            <table class="table table-responsive table-bordered table-hover table-striped bill-address">
                                <tr>
                                    <td><?php echo LANG_VALUE_102; ?></td>
                                    <td><p id="ecname"><?php echo $_SESSION['customer']['cust_b_name']; ?></p></td>
                                </tr>
                                <tr>
	                	...
	                	<?php else: ?>
		                	<div class="col-md-4">
	                            ...
	                            <div class="row">
                                    ...
                                    <!-- paypal payment form starts here-->
                                    ...
                                    <!-- paypal payment form ends here-->

                                    <!-- paystack form starts here -->
                                    <form class="paypal" id="paystack_form">
                                        <script src="https://js.paystack.co/v1/inline.js"></script>
                                        <input type="hidden" id="eall_total" name="final_total" value="<?php echo $final_total; ?>">
                                        <div class="col-md-12 form-group">
                                            <button type="button" class="btn btn-sm-primary" onclick="makePayment('ecemail', 'eall_total', 'ecname')">
