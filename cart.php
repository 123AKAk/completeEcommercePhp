                    ...
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a onclick="cartconfirmDelete('cart-item-delete.php?id=<?php echo $arr_cart_p_id[$i]; ?>&size=<?php echo $arr_cart_size_id[$i]; ?>&color=<?php echo $arr_cart_color_id[$i]; ?>');" href="javascript:void(0);" class="trash"><i class="fa fa-trash" style="color:red;"></i></a>
                            </td>
                        </tr>
                        <?php endfor; ?>
                        <tr>
...
<?php if(isset($allow_update) == 0): ?>
    
<?php else: ?>
    <script>
        alertify.alert("All Items Quantity Update is Successful!.", function(){
            alertify.message('OK');
        });
    </script>
<?php endif; ?>