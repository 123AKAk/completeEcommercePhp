...
<head>
	...
	<link href="assets/js/alertify/css/alertify.css" rel="stylesheet">
	<link href="assets/js/alertify/css/alertify.min.css" rel="stylesheet">

	<link href="assets/js/alertify/css/themes/bootstrap.css" rel="stylesheet">
	<link href="assets/js/alertify/css/themes/bootstrap.min.css" rel="stylesheet">

	<link href="assets/js/alertify/css/themes/default.css" rel="stylesheet">
...
<!-- top bar -->
<div class="top" style="background:#002e5b">
	<div class="container">
		<div class="row">
...
<div class="header">
	<div class="container">
		<div class="row inner">
			...
			<div class="col-md-5 right" id="divrefresh">
				<ul>
...
<div class="nav" style="background:#002e5b">
	<div class="container">
		<div class="row">
			<div class="col-md-12 pl_0 pr_0">
				<div class="menu-container" style="background:#002e5b">
					<div class="menu">
						<ul>
